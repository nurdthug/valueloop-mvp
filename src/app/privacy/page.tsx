...
export const metadata = {
  title: 'Privacy Policy â ValueLoop',
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-4 py-10 pb-20">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
          ...
          <div className="prose prose-sm max-w-none text-gray-600 space-y-6">
            ...
            <section>
              ...
              <p>ValueLoop is operated by <strong>Zean LLC</strong> ("we," "us," or "our"). We provide a peer-to-peer value exchange platform at <a href="https://valueloop.app" className="text-teal-600">valueloop.app</a> that helps users trade skills, services, and resources without cash. Questions can be directed to <a href="mailto:hello@valueloop.app" className="text-teal-600">hello@valueloop.app</a>.</p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-1 space-y-1">
                ...
                <li>Payment information: processed entirely by Stripe â we never see or store your card details</li>
              </ul>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-1 space-y-1">
                <li><strong>Supabase</strong> â Our database and authentication provider</li>
                <li><strong>Stripe</strong> â payment processing (only when you make or may receive a cash payment)</li>
                <li><strong>Google / Anthropic</strong> â AI matching and pricing suggestions (post content only)</li>
                <li><strong>Vercel</strong> â our hosting provider</li>
            ...
            <section>
              ...
              <p>Depending on where you live, you may have the right to access, correct, or delete your personal data. To make a request, email <a href="mailto:hello@valueloop.app" className="text-teal-600">hello@valueloop.app</a>. We will respond within 30 days.</p>
            </section>
        ...
        <div className="text-center mt-6 flex items-center justify-center gap-4 text-sm text-gray-400">
          <Link href="/terms" className="hover:text-teal-600 transition">Terms of Service</Link>
          <span>Â·</span>
