      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5 py-8">
        ...
        <div className="w-full max-w-sm">
          <div className="mb-6 text-center">
            ...
            {inviteCode && (
              <div className="mt-2 inline-flex items-center gap-1.5 bg-teal-50 text-teal-700 text-xs font-semibold px-3 py-1.5 rounded-full">
                ð You were invited!
              </div>
            )}
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 mb-6">
            {[['ð¤', 'AI Matching'], ['ð', 'Direct Swaps'], ['ð¤', 'Real Value']].map(([emoji, label]) => (
